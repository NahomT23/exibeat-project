    ...
    <>
      <div className="flex justify-center items-center mt-5">
        <div className="w-96 p-6 bg-white border border-dashed border-black rounded-lg">
          ...
          <p className="text-sm hkg-light text-gray-600 text-center mb-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                ...
                {editingTrack ? (
                  <input
                    ...
                    onBlur={handleBlur}
                    className="text-sm hkg-regular font-medium text-gray-800 border-b border-gray-400 outline-none"
                    placeholder="Enter track"
                  />
                ) : (
                  <span className="text-sm hkg-regular font-medium text-gray-800">
                    {trackName}
                  </span>
                )}
              </div>
              ...
              {!editingTrack && (
                <span
                  className="text-sm hkg-regular font-medium text-gray-800 cursor-pointer"
                  onClick={resetTrack}
                >
                  X
                </span>
          ...
          {message && (
            <p className="text-sm hkg-regular text-gray-800 mb-6">{message}</p>
          )}

          {!isSubmitted && (
            <p
              className="text-sm hkg-regular text-gray-600 mb-6 cursor-pointer"
          ...
          {!isSubmitted && (
            <div className="flex items-center justify-center">
              <Button
                className="w-full hkg-bold bg-blue-600"
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <div className="flex justify-between items-center">
                <DialogTitle className="text-2xl text-center w-full hkg-bold">
                  ADD MESSAGE
                </DialogTitle>
              </div>
            </DialogHeader>

            <label className="block text-sm hkg-regular font-medium text-gray-700 -mb-3">
              Message
            </label>
